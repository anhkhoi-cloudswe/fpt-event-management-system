          ...
          <div className="flex-1 overflow-y-auto px-5 py-5 sm:px-6">
            {loading && (
              <div className="flex justify-center items-center py-8">
                <div className="inline-flex items-center gap-3">
                  ...
                  <span className="text-slate-500 dark:text-slate-400">Đang tải thông tin chi tiết...</span>
                </div>
              </div>
            )}
            ...
            {request.organizerNote && (
              <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-950/20 rounded-lg border border-blue-200 dark:border-blue-900/50">
                <h3 className="text-sm font-semibold text-blue-900 dark:text-blue-400 mb-2">Ghi chú từ ban tổ chức</h3>
                <p className="text-sm text-blue-800 dark:text-blue-300 whitespace-pre-wrap">{request.organizerNote}</p>
              </div>
            )}
