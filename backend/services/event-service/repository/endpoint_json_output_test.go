...
func TestJSONOutput_PublicDashboardTimes_AreVietnam(t *testing.T) {
	...
	startVN := time.Date(2026, 3, 31, 9, 0, 0, 0, vnLoc)
	endVN := time.Date(2026, 3, 31, 16, 0, 0, 0, vnLoc)
		...
		Data: []models.EventListItem{
			{
				...
				StartTime: formatTimeToWallClockRFC3339(startVN),
				EndTime:   formatTimeToWallClockRFC3339(endVN),
			},
		},
		Total:      1,
		Page:       1,
...
func TestJSONOutput_PublicDashboardTimes_Converts0100UTCTo0800VN(t *testing.T) {
	vnLoc := utils.VietnamLocation()
	startVN := time.Date(2026, 3, 31, 8, 0, 0, 0, vnLoc)
	endVN := time.Date(2026, 3, 31, 12, 0, 0, 0, vnLoc)
...
func TestJSONOutput_PublicDashboardTimes_Converts0000UTCTo0700VN(t *testing.T) {
	vnLoc := utils.VietnamLocation()
	startVN := time.Date(2026, 3, 30, 7, 0, 0, 0, vnLoc)
	endVN := time.Date(2026, 3, 30, 12, 0, 0, 0, vnLoc)
...
func TestFormatTimeToWallClockRFC3339_FormatsWithVNTimezone(t *testing.T) {
	vnInput := time.Date(2026, 3, 31, 9, 0, 0, 0, utils.VietnamLocation())

	got := formatTimeToWallClockRFC3339(vnInput)
