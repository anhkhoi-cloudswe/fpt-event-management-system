...
type EventDetailDto struct {
	...
	VenueLocation *string `json:"venueLocation,omitempty"`
...
// SampleBanner - Model and DTO for template cover images

// ============================================================

type SampleBanner struct {
...
type CreateSampleBannerRequest struct {
	Title string `json:"title"`
